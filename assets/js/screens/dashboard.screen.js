  ...
  render: function(){
    try {
      ...
      var html = ''
        ...
        + '  <div><h1 class="screen-title">Dashboard</h1><div class="screen-subtitle">Layout da Fase 1 preservado, agora com dados reais do storage local.</div></div>'
        + '  <div class="actions-row"><button class="btn btn-primary" data-go="obras">Ver obras</button><button class="btn" data-go="financeiro">Abrir financeiro</button></div>'
        + '</div>'
        + '<div class="hero"><h2>Painel financeiro e operacional</h2><p>Visão mais limpa e intuitiva: foco nos números principais, alertas na lateral e resumo secundário abaixo.</p></div>'
        + '<div class="kpi-grid">'
        + '  <button class="kpi-card kpi-click" data-go="financeiro"><div class="kpi-label">Receita contratada</div><div class="kpi-value">' + OBRAS.helpers.money(m.receitaContratada) + '</div><div class="kpi-note">Abrir financeiro</div></button>'
        + '  <button class="kpi-card kpi-click" data-go="financeiro"><div class="kpi-label">Receita recebida</div><div class="kpi-value">' + OBRAS.helpers.money(m.receitaRecebida) + '</div><div class="kpi-note">Abrir financeiro</div></button>'
        + '  <button class="kpi-card kpi-click" data-go="obras"><div class="kpi-label">A receber</div><div class="kpi-value">' + OBRAS.helpers.money(m.aReceberObras) + '</div><div class="kpi-note">Ver obras</div></button>'
        + '  <button class="kpi-card kpi-click" data-go="financeiro"><div class="kpi-label">Saldo de caixa</div><div class="kpi-value">' + OBRAS.helpers.money(m.caixaRealizado) + '</div><div class="kpi-note">Abrir financeiro</div></button>'
        + '</div>'
        ...
        + '  </div>'
        + '  <div class="list-card"><h3 class="card-title">Alertas e próximos passos</h3>' + avisoHtml + '</div>'
        + '</div>'
